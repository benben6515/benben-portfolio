...
function ResumeProfile({ data, lang = 'en' }) {
  const { skills, projects } = data
  const t = labels[lang]
  const toggleLangHref = lang === 'en' ? '/resume/tw' : '/resume/en'
        ...
        <Section>
          <SectionItem>
            ...
            <ItemWrapper>
              ...
              <ItemDescription>{t.personalBlogDesc}</ItemDescription>
            </ItemWrapper>
            <ItemWrapper>
              <ItemName>
              ...
              <ItemDescription>{t.collabBlogDesc}</ItemDescription>
            </ItemWrapper>
          </SectionItem>
        </Section>
      </ProfileWrapper>
